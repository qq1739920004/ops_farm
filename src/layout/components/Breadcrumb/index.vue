<template>
  <div class="breadcrumb-container" :class="{'breadcrumb-visible-container':breadcrumbs.length==0}">
   <SvgIcon
     v-if="isBackShow"
     class="back_icon"
     icon="back"
   ...
   <el-breadcrumb class="app-breadcrumb">
     <el-breadcrumb-item v-for="(item, index) in breadcrumbs" 
       ...
       <span
         v-if="
           item.redirect === 'noredirect' || index === breadcrumbs.length - 1||(index == 0&&breadcrumbs.length>1)
         "
         class="no-redirect"
