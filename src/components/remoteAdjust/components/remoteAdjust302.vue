  ...
  >
    ...
    <div class="menuArea">
      <el-tabs stretch v-model="activeName" class="demo-tabs" @tab-click="handleClick">
        ...
        <el-tab-pane :label="$t('work.pidParameters')" name="9"></el-tab-pane>
        <el-tab-pane
    ...
    <div class="mainContent">
      ...
      >
        ...
        <div class="buttonarea">
          <el-button
            v-if="carParamsData"
            :disabled="!carParamsData"
            type="primary"
            @click="updateCarParams"
      ...
      >
        ...
        <div class="buttonarea">
          <el-button v-if="CalibTitleData" type="primary" @click="updateCalibParams">{{
            $t("work.submit")
          }}</el-button>
        </div>
      </el-form>
      ...
      >
        ...
        <div class="buttonarea">
          <el-button v-if="PidTitleData" type="primary" @click="updatePidParams">{{
            $t("work.submit")
          }}</el-button>
        </div>
      </el-form>
      ...
      >
        <el-row>
          <el-col
            v-if="PidCurveTitleData"
            :span="12"
            v-for="(value, key, index) in PidCurveTitleData"
            :key="index"
          >
            <el-form-item class="item" :label="value.name" :prop="key">
      ...
      >
        <el-row>
          <el-col
            v-if="PidSupLowTitleData"
            :span="12"
            v-for="(value, key, index) in PidSupLowTitleData"
            :key="index"
          >
            <el-form-item class="item" :label="value.name" :prop="key">
        ...
        <div class="buttonarea">
          <el-button
            :disabled="!PidSupLowTitleData"
            type="primary"
            @click="updatePidSupLowParams"
            >{{ $t("work.submit") }}</el-button
          >
        </div>
      </el-form>
      ...
      >
          ...
          <el-col :span="18" :offset="6">
            <el-form-item class="item" :label="$t('work.workingMode')">
              <el-select v-model="workPattern.type" style="width: 187px; height: 32px">
                ...
                <el-option :label="$t('work.builtInRadio')" :value="0"></el-option>
              </el-select>
              <el-button
        ...
        <div v-show="workPattern.type == '0'">
          ...
          <el-row style="margin-bottom: 10px">
            <el-col :span="12" :offset="6">
              <el-form-item class="item" :label="$t('work.channel')" prop="radioChannel">
                <el-select
                  style="width: 187px; height: 32px"
                  v-model="chaFenlist.radioChannel"
                >
                  <el-option
                    v-if="chaFenlist.protocol === 2"
                    :label="$t('work.custom')"
                    :value="0"
                  />
            ...
            <el-input-number
              v-show="chaFenlist.radioChannel === 0"
              :label="$t('work.custom')"
              :value="0"
              v-model="custom"
              clearable
          ...
          <el-row style="margin-bottom: 10px">
            <el-col :span="12" :offset="6">
              <el-form-item class="item" :label="$t('work.mode')" prop="radioStatus">
                <el-select
                  style="width: 187px; height: 32px"
                  v-model="chaFenlist.radioStatus"
                >
          ...
          <el-row style="margin-bottom: 10px">
            <el-col :span="12" :offset="6">
              <el-form-item class="item" :label="$t('work.power')" prop="radioPower">
                <el-select
                  style="width: 187px; height: 32px"
                  v-model="chaFenlist.radioPower"
                >
      ...
      >
        ...
        <div class="buttonarea">
          <el-button
            type="danger"
            :disabled="productList.length >= 1 ? false : true"
      ...
      >
        <el-row>
          <el-col align="center">
            {{ $t("work.logUploadNotAvailableAG302") }}
          </el-col>
        </el-row>
      </el-form>
    </div>
...
const updateChafenData2 = async () => {
  if (chaFenlist.value.protocol === 2 && chaFenlist.value.radioChannel === 0) {
