const en = {
  ...
  menus: {
    ...
    machineryList: "Machinery manage",
    jobList: 'Project list',
    projectMan: 'Project Mgt',
    qualityMgt: 'Warranty Mgt',
    insights: 'Intelligent insights',
    alarmStatics: 'Alarm statics',
    jobStatics: 'Project statics',
  ...
  statisticsReport: {
    ...
    thousandArea: 'area(thousand acres)',
    workingHours: 'Working hours',
    numbertem: 'Searchable by name or phone number',
  },
  job: {
    fix: 'fix',
    others: 'others(single point,float or others)',
    SatelliteBase: 'Satellite base',
    lines: 'locus lines',
    point: 'locus point',
    acTime: "Job duration",
    milerage: 'Job mileage',
    mu: 'mu',
    meter: 'meters',
    work: 'job'
  },
