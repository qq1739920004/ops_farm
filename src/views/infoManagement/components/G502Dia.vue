...
<template>
    <div>
        <el-dialog v-model="dialogVisible" :title="newRecords.id ?  $t('work.edit') :  $t('work.new')" width="544px" height="580px">
            <el-form label-width="140px" style="width: 90%" ref="formRef" :model="newRecords" :rules="rules">
                ...
                <el-form-item :label="$t('work.Antenna2_SN')" prop="antennaTwo">
