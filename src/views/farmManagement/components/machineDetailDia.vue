  ...
  >
      ...
      <div class="line line3">
        ...
        <div class="data data4" :class="NewDetail.onlineTcp != 0 ? 'circlearea' : ''">
          ...
          <span v-if="NewDetail.onlineTcp != 0"
            >({{ $t("work.online") }}) <span class="circle"></span
          ></span>
    ...
    <div class="tableData">
      <div class="line line3">
        ...
        <div class="tit" v-if="locale.includes('zh')">
          {{ $t("work.warrantyExpiration") }}:
        </div>
        <div class="data" v-if="locale.includes('zh')">{{ NewDetail.warrantyDate }}</div>
        <div class="tit" v-if="locale.includes('zh')">
          {{ $t("work.nettingExpiration") }}:
        </div>
        <div class="data" v-if="locale.includes('zh')">{{ NewDetail.netDate }}</div>
      </div>
